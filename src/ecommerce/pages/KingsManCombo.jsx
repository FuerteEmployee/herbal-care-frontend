...
export default function KingsManCombo() {
  ...
  useEffect(() => {
    document.title = "Herbal King's Man Combo | Herbal Gujarat";
  }, []);

  return (
    <main ref={pageRef}>
      <TopBar />
      <Header bookNowHref="/checkout?pack=combo" />

      <PageHead
        breadcrumbs={[{ label: 'Home', to: '/' }, { label: "Herbal King's Man Combo" }]}
        title={
          <>
            Herbal <span className="gold-text">King&apos;s Man Combo</span>
          </>
        }
        subtitle="Double the Vitality, Double the Value — Two bottles of premium Ayurvedic wellness formula at the price of one."
      />
        ...
        <div className="wrap">
          <div className="pdp">
            ...
            <div className="reveal">
              ...
              <h2 className="pdp__title">Herbal King&apos;s Man — Combo Pack</h2>
              ...
              <p style={{ fontSize: '.9rem', margin: '-8px 0 22px', color: '#8b917f' }}>
                Two sealed bottles — 2 × 30 capsules, 60 in total. Inclusive of all taxes.
              </p>
              ...
              <p style={{ fontSize: '.88rem', margin: '-10px 0 22px' }}>
                ...
                <Link to="/kings-man" style={{ color: 'var(--gold-deep)', fontWeight: 600, borderBottom: '1px solid var(--gold)' }}>
                  Book the single 30-capsule pack at ₹999
                </Link>
              </p>
              ...
              <div className="table-scroll">
                <table className="specs">
                  <tbody>
                    ...
                    <tr>
                      <th>Quantity</th>
                      <td>60 Capsules (2 bottles of 30)</td>
                    </tr>
                    <tr>
                      <th>Key Herbs</th>
      ...
      <section className="section" id="order">
        <div className="wrap">
          ...
          <div className="inquiry__in">
            ...
            <EnquiryForm source="Product Combo Page">
              ...
              <div className="form__row">
                <div className="field">
                  ...
                  <select id="o-pack" name="pack" required defaultValue="Combo — Buy 1 Get 1 Free, 60 capsules (₹1,499)">
